# Game engine implementation for Hangman
defmodule Hangman.Impl.Game do
  ...
  @spec new_game :: t
  def new_game() do
    new_game(Dictionary.get_random_word())
  end

  @spec new_game(String.t) :: t
  def new_game(word) do
    %__MODULE__{
      letters: word |> String.downcase(:default) |> String.codepoints()
    }
  end
  ...
  def make_move(game, guess) do
    clean_guess = String.downcase(guess, :default)
    accept_guess(game, clean_guess, MapSet.member?(game.used, clean_guess))
    |> return_with_tally()
  end
